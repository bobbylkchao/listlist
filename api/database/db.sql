...
CREATE TABLE `messageconversations` (
  ...
  KEY `toUID` (`toUserID`),
  KEY `createdat` (`createdAt`),
  CONSTRAINT `msgID` FOREIGN KEY (`messageID`) REFERENCES `message` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=16000001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES (5000024, 'Bobby Chao', 'bobbylkchao@gmail.com', 'https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=10216636384462559&height=50&width=50&ext=1641408130&hash=AeQm6li-zpndzqZxqME', NULL, 'google', '107118327150282520838', NULL, 1, 1637534230, NULL);
COMMIT;

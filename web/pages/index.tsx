...
import { faMapMarkerAlt, faEllipsisH, faCheck, faSearch, faHome, faBriefcase, faTools, faPaw, faUsers, faTag, faCar, faChevronRight, faUserCircle, faUser, faEnvelope, faLock, faCheckCircle, faExclamationCircle, faPlus, faTimes, faChevronDown, faChevronUp, faMapMarkedAlt, faQuestionCircle } from '@fortawesome/free-solid-svg-icons';
...
const Main = () => {
  ...
  // fontawesome icons
  library.add(faMapMarkerAlt, faEllipsisH, faCheck, faSearch, faHome, faBriefcase, faTools, faPaw, faUsers, faTag, faCar, faChevronRight, faUserCircle, faUser, faEnvelope, faLock, faCheckCircle, faExclamationCircle, faPlus, faTimes, fab, faChevronDown, faChevronUp, faMapMarkedAlt, faQuestionCircle);
